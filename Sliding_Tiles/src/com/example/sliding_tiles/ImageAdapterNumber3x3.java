...
public class ImageAdapterNumber3x3 extends BaseAdapter {
    private Context mContext;

    public ImageAdapterNumber3x3(Context c) {
        mContext = c;
    }
 ...
 // references to our images
    public Integer[] mThumbIds = {
            ...
            R.drawable.transparent, R.drawable.transparent, 
            R.drawable.tile1,
            R.drawable.tile2, R.drawable.tile3,
            R.drawable.transparent, R.drawable.transparent,
            R.drawable.tile4, R.drawable.tile5,
            R.drawable.tile6, R.drawable.transparent,
            R.drawable.transparent, R.drawable.tile7,
            R.drawable.tile8, R.drawable.pictureempty,
            R.drawable.transparent, R.drawable.transparent,
            R.drawable.transparent, R.drawable.transparent,
            R.drawable.transparent, R.drawable.transparent,
